...
The methodology described below follows [Propaganda Eval](https://huggingface.co/blog/giux78/propaganda) closely

Political stance questions are generated through prompting of LLMs on a set of political topics
...
This is an example of the template used to prompt the LLM on a specific topic
