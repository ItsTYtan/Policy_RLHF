...
directory='../models'
fullpath='../models/ablation-3/checkpoint-50000'
mmlu_datasets=[
    dict(abbr='lukaemon_mmlu_college_biology',
        eval_cfg=dict(
            evaluator=dict(
...
models=[
    dict(abbr='ablation-0_README.md',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-0/README.md',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-0/README.md',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-0_ablation_params.json',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-0/ablation_params.json',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-0/ablation_params.json',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-0_checkpoint-10000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-0/checkpoint-10000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-0/checkpoint-10000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-0_checkpoint-20000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-0/checkpoint-20000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-0/checkpoint-20000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-0_checkpoint-30000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-0/checkpoint-30000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-0/checkpoint-30000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-0_checkpoint-40000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-0/checkpoint-40000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-0/checkpoint-40000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-0_checkpoint-50000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-0/checkpoint-50000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-0/checkpoint-50000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-0_checkpoint-60000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-0/checkpoint-60000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-0/checkpoint-60000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-1_README.md',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-1/README.md',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-1/README.md',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-1_ablation_params.json',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-1/ablation_params.json',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-1/ablation_params.json',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-1_checkpoint-10000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-1/checkpoint-10000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-1/checkpoint-10000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-1_checkpoint-20000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-1/checkpoint-20000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-1/checkpoint-20000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-1_checkpoint-30000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-1/checkpoint-30000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-1/checkpoint-30000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-1_checkpoint-40000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-1/checkpoint-40000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-1/checkpoint-40000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-1_checkpoint-50000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-1/checkpoint-50000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-1/checkpoint-50000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-1_checkpoint-60000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-1/checkpoint-60000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-1/checkpoint-60000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-2_README.md',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-2/README.md',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-2/README.md',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-2_ablation_params.json',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-2/ablation_params.json',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-2/ablation_params.json',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-2_checkpoint-10000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-2/checkpoint-10000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-2/checkpoint-10000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-2_checkpoint-20000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-2/checkpoint-20000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-2/checkpoint-20000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-2_checkpoint-30000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-2/checkpoint-30000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-2/checkpoint-30000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-2_checkpoint-40000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-2/checkpoint-40000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-2/checkpoint-40000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-2_checkpoint-50000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-2/checkpoint-50000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-2/checkpoint-50000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-3_README.md',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-3/README.md',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-3/README.md',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-3_ablation_params.json',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-3/ablation_params.json',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-3/ablation_params.json',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-3_checkpoint-10000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-3/checkpoint-10000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-3/checkpoint-10000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-3_checkpoint-20000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-3/checkpoint-20000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-3/checkpoint-20000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-3_checkpoint-30000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-3/checkpoint-30000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-3/checkpoint-30000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-3_checkpoint-40000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-3/checkpoint-40000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-3/checkpoint-40000',
        type='opencompass.models.HuggingFaceCausalLM'),
    dict(abbr='ablation-3_checkpoint-50000',
        batch_padding=False,
        batch_size=16,
        max_out_len=100,
        max_seq_len=2048,
        path='../models/ablation-3/checkpoint-50000',
        run_cfg=dict(
            num_gpus=1),
        tokenizer_kwargs=dict(
            padding_side='left',
            truncation_side='left'),
        tokenizer_path='../models/ablation-3/checkpoint-50000',
        type='opencompass.models.HuggingFaceCausalLM'),
    ]
work_dir='outputs/default/20250731_083424'